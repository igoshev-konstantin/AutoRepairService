...
@Configuration          /*Обозначаем DI и DoC для Spring*/
@ComponentScan("myApplication")            /*Обозначаем место сканирования для IC и DoC*/
...
public class MyConfig {
    ...
    public DataSource dataSource() {
        ...
        try {
            ...
            dataSource.setJdbcUrl("jdbc:mysql://localhost:3306/db_autoservice?useSSL=false&serverTimezone=UTC");
    ...
    public LocalSessionFactoryBean sessionFactory() {
        ...
        sessionFactory.setPackagesToScan("myApplication");
